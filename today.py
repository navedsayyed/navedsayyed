...
def svg_overwrite(filename, age_data, commit_data, star_data, repo_data, contrib_data, follower_data, loc_data):
    ...
    root = tree.getroot()
    justify_format(root, 'age_data', age_data, 49) # was accepted but never written upstream
...
if __name__ == '__main__':
    """
    Original: Andrew Grant (Andrew6rant), 2022-2025
    Adapted by: Naved A. Sayyed (navedsayyed)
    """
    ...
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2004, 10, 7))
